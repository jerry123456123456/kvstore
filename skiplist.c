...
int main() {
    ...
    insert(skipList, 5, 41);
    insert(skipList, 8, 42);
    insert(skipList, 32, 22);
    insert(skipList, 42, 32);
    insert(skipList, 14, 12);
    insert(skipList, 24, 1);
    insert(skipList, 31, 2);
    insert(skipList, 9, 33);
    display(skipList);
